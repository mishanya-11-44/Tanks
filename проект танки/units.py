...
class Unit:
    def __init__(self, canvas, x, y, speed,padding,bot,default_image):
        ...
        self._died_image=default_image
        self._create()
    ...
    def died(self):
        self._canvas.itemconfig(self._id, image=skin.get(self._tank_destroyed))
    def stop(self):
        self._vx=0
        self._vy=0
    def update(self):
...
class Tank(Unit):
    def __init__(self,canvas,row,col,bot=True):
        ...
        if bot:
            ...
            self._tank_destroyed='tank_destroyed'
        self.forward()
        self._ammo=80
        self._fuel=10000
    ...
    def _AI_fire(self):
        ...
        center_y=self.get_x()+self.get_size()//2
    ...
    def _take_speed(self):
        self._usual_speed=self._usual_speed*2
        self._water_speed=self._water_speed*2
    def _on_map_collision(self,details):
